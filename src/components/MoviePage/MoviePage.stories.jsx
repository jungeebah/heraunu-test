...
export default {
    title: 'Section/MoviePage',
    component: 'MoviePage',
}
const theme = { dark: darkTheme, light: lightTheme };
const DarkThemeTemplate = (...args) => <ThemeProvider theme={theme['dark']}><MoviePage {...args} /></ThemeProvider>
const Template = (...args) => <ThemeProvider theme={theme['light']}><MoviePage {...args} /></ThemeProvider>;
