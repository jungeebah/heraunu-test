...
const DarkThemeTemplate = (...args) => <ThemeProvider theme={theme['dark']}><Songs {...args} /></ThemeProvider>
const Template = (...args) => <ThemeProvider theme={theme['light']}><Songs {...args} /></ThemeProvider>;
